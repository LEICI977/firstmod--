...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="Vivant Valley local LangGraph service")
    parser.add_argument("--host", default=os.environ.get("VIVANT_LANGGRAPH_HOST", "127.0.0.1"))
    parser.add_argument("--port", type=int, default=int(os.environ.get("VIVANT_LANGGRAPH_PORT", "8123")))
