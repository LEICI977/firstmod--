...
每次普通对话会组合当前游戏事实、NPC 基础性格、专属人格资料、近期聊天、长期摘要和部分原版剧情记录。专属人格资料位于 `assets/social/npc-personas.json`，可直接调整每名村民的核心身份、说话方式、价值观、兴趣、边界和关系表达。当前存档事实优先于旧记忆，提示词要求模型保持角色身份，并禁止提前泄露尚未发生的事件或任务结局。
